...
import { hardwareTools } from "../../data/product";
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        Explore our range of industrial hardware tools and accessories including cable ties, DIN rails, lock nuts, plugs, electrical tapes, hand tools and installation hardware.
        </p>
