...
import { warningLights } from "../../data/product";
    ...
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
          Explore our range of warning lights including LED strobe lights,
           revolving lights, aviation obstruction lights, flashers and 
           industrial visual signaling solutions for safety and emergency applications.
        </p>
