...
import { electricalAccessories }from "../../data/product";


export default function ElectricalAccessories() {
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
          Explore our range of electrical accessories including blowers, pilot lights, contactors, relays, MCBs, panel accessories, pneumatic components and industrial electrical solutions.
</p>
      </div>
      ...
      {/* Product Grid */}
            ...
            {electricalAccessories.map((product) => ( <div
               key={product.id}
               className="
                 bg-white
                 rounded-2xl
