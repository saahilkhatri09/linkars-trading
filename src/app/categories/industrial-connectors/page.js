...
import { industrialConnectors } from "../../data/product";
    ...
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
         Explore our range of industrial connectors including heavy-duty connectors, hoods, housings, inserts and reliable industrial connectivity solutions for automation and electrical applications.
        </p>
      ...
      {/* Product Grid */}
            ...
            {industrialConnectors.map((product) => ( <div
               key={product.id}
               className="
                 bg-white
                 rounded-2xl
