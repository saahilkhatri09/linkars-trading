...
import { emergencySystems } from "../../data/product";
    ...
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
         Explore our range of emergency systems including emergency lights, hooters, buzzers, gong bells, audio visual alarms and industrial safety alert systems.
        </p>
      ...
      {/* Product Grid */}
            ...
            {emergencySystems.map((product) => ( <div
               key={product.id}
               className="
                 bg-white
                 rounded-2xl
