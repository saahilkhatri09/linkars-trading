...
import { cableGlands}from "../../data/product";


export default function CableGlands(){
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-gray-600 max-w-3xl mx-auto">
         Explore our range of cable glands including brass cable glands, EMC glands, stainless steel glands, plastic glands and cable management accessories for industrial installations.
        </p>
      ...
      {/* Product Grid */}
            ...
            {cableGlands.map((product) => ( <div
             ...
             >
              ...
              <div className="p-4 flex justify-center items-center h-56 bg-white">
